...
export const CoursesIcons = () => {
  return (<>
    ...
    <div className="  container   coursesIconsGrand d-flex flex-column flex-md-row justify-content-around align-items-center ">
     
      <div className="VideoSecImg ">
        <img src={compCHarc} alt="comp" />
      </div>
      <div className="videoParent w-50  d-flex justify-content-center align-items-center">

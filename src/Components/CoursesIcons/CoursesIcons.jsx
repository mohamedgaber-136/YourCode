...
<div className="svgsImg" data-aos="fade-right" data-aos-once="true" data-aos-duration="2000" data-aos-delay="500">
  <img src={svgBlue} alt="svg" />
</div>
      <div className="videoParent    d-flex justify-content-center align-items-center" data-aos-once="true" data-aos-duration="2000" data-aos-delay="500" data-aos="zoom-in">
        <video src={video} autoPlay='true' loop='true' muted className="    p-0 m-0" />
      </div>
      <div className=" ImgVideoParent" data-aos-once="true" data-aos-duration="2000" data-aos-delay="500" data-aos="zoom-in">
  ...
  <svg
    ...
    style={{ fill: '#daa520', width: '100%', height: 232, transform: 'rotate(180deg)' }}
  >
    <path

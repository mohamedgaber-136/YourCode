...
export const BenefitsSection = () => {
  ...
  <svg
    ...
    style={{ fill: '#202252', width: '100%', height: 232, }}
  >
    <path
      ...
      <div >
        ...
        <Container className="mainSpacer  d-flex flex-column justify-content-center align-items-center ">
          <SectionLabel
            ...
            buttonColor={"light"}
          />
          <div className="d-flex benefitParent flex-wrap justify-content-center align-items-center" data-aos="fade-down"  data-aos-delay="500"  data-aos-once="true" data-aos-duration="2000" data-aos-easing="linear">
